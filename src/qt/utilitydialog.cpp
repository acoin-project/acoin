    ...
    ui(new Ui::AboutDialog)
{
    ...
    ui->copyrightLabel2->setText(tr("Copyright") + QString(" &copy; 2013-%1 ").arg(COPYRIGHT_YEAR) + tr("The Acoin Core developers"));
}
    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    header = tr("Acoin Core") + " " + tr("version") + " " +
...
void ShutdownWindow::showShutdownWindow(BitcoinGUI *window)
{
    ...
    layout->addWidget(new QLabel(
        tr("Acoin Core is shutting down...") + "<br /><br />" +
